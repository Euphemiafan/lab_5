	...
	for (row = 2; row < table.rows.length; row++)
		{
			...
			home = Number(home);
			oppo = table.rows[row].cells[3].innerHTML;
			oppo = Number(oppo);
			if (home > oppo)
				{
					win++;
	...
	for (var i = 0; i < player.length; i++)
		{
			...
			anchor.innerHTML = player[i].name;
			/*
...
function switchPlayers(playerNum)
{
	...
	document.getElementById('avg_p_yards').innerHTML = avgp;
	document.getElementById('avg_r_yards').innerHTML = avgr;
